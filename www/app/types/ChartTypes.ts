...
export function getChartLabels(resource: string, data: any): Labels {
	switch (resource) {
		...
		case 'disk':
			let diskData = data as InstanceTypes.DiskChart;
		...
		case 'diskio0':
		case 'diskio1':
			let diskioData = data as InstanceTypes.NetworkChart;
		...
		case 'network':
			let netData = data as InstanceTypes.NetworkChart;
...
export function getChartData(resource: string, data: any): Chart {
	switch (resource) {
		...
		case 'diskio0':
		case 'diskio1':
			let diskioData = data as InstanceTypes.DiskIoChart;
